...
function App() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-slate-50">
      ...
      <div className="z-10 fixed left-4 top-4 rounded-full border border-slate-200 bg-white/95 px-4 py-2 shadow-lg backdrop-blur inline-block cursor-pointer"
        onClick={e => {
          e.stopPropagation();
      ...
      >
        <div className="flex items-center gap-2.5">
          ...
          <label htmlFor="reLoadProduct"
            className="text-xs font-semibold uppercase tracking-wide text-slate-600 select-none cursor-pointer"
            onClick={e => {
              e.stopPropagation();
            }}
          >

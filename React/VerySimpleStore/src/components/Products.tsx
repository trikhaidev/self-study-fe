...
export default function Products({ onShowProduct }: ProductsProps) {
    ...
    return (
        <div className="mx-auto w-full max-w-7xl px-4 pb-12 pt-24 md:px-8">
            ...
            <div className="sticky top-3 z-20 mb-8 flex flex-col gap-3 rounded-2xl border border-slate-200/80 bg-white/95 p-3 shadow-[0_10px_30px_-20px_rgba(15,23,42,0.4)] backdrop-blur md:flex-row md:items-center md:p-4">
                <input
                    type="text"
